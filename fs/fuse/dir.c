...
int fuse_lookup_name(struct super_block *sb, u64 nodeid,
  ...
  u64 attr_version;
  int err;
  //printk("zzzfuse_lookup_name need new req\n");
...
static int create_new_entry(struct fuse_mount *fm, struct fuse_args *args,
  ...
  int err;
  struct fuse_forget_link *forget;
  //printk("zzzcreate_new_entry need new req\n");
...
static int fuse_rename_common(struct inode *olddir, struct dentry *oldent,
  ...
  FUSE_ARGS(args);
  //printk("zzzfuse_rename_common need new req\n");
...
void fuse_set_nowrite(struct inode *inode) {
 ...
 // printk("zzz fuse_set_nowrite now :%d\n",fi->writectr);
...
int fuse_flush_times(struct inode *inode, struct fuse_file *ff) {
  ...
  //printk("zzzfuse_flush_times need new req\n");
